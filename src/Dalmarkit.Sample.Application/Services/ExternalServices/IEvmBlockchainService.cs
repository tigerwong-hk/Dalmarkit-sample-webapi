...
public interface IEvmBlockchainService
{
    ...
    Task<string?> GetEvmEventByNameAsync(string eventName, string contractName, string[] contractCallerAddresses, string transactionHash, BlockchainNetwork blockchainNetwork);
    Task<List<EvmEventDto>?> GetEvmEventsByNameAsync(string eventName, string contractName, string[] contractCallerAddresses, string transactionHash, BlockchainNetwork blockchainNetwork);
